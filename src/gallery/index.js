...
export default class Gallery extends PureComponent {
    ...
    componentWillMount() {
      ...
      this.gestureResponder = createResponder({
        ...
        onResponderSingleTapConfirmed: (evt, gestureState) => {
          this.props.onSingleTapConfirmed && this.props.onSingleTapConfirmed(this.currentPage, evt, gestureState);
        },
      });
    ...
    renderPage(pageData, pageId) {
      const {
        onViewTransformed, onTransformGestureReleased, errorComponent, imageComponent,
      } = this.props;
      return (
        <TransformableImage
